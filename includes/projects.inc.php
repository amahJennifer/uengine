...
if (isset($_GET['projectid'])) {
    ...
    ($mysqli = new mysqli('localhost', 'root', '1527', 'uengine')) or
        die(mysqli_error($mysqli));
    ($project = $mysqli->query(
...
if (isset($_GET['engineer_id'])) {
    ...
    if (!mysqli_stmt_prepare($stmt, $sql)) {
        ...
        if ($resultCount > 0) {
            ...
            $sql =
                'INSERT INTO project_eng (project_id,project_title,project_description,project_deadline,engineer_id) VALUES (?,?,?,?,?); ';
